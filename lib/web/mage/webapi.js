...
(function (factory) {
    ...
    $.mage.Webapi = function(baseUrl, ajaxArgs) {
        /**
         * ResourceModel-related parameters. Further extended by other domain objects like Product, etc.
         *
         * @const
         ...
         *
         * @param {string}           resourceUri ResourceModel URI request to be sent to, e.g. '/v1/products/'
